...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Stappy2/Mantle.framework"
  install_framework "Pods-Stappy2/NSDate_Calendar.framework"
  install_framework "Pods-Stappy2/SDWebImage.framework"
  install_framework "Pods-Stappy2/SMSegmentView.framework"
  install_framework "Pods-Stappy2/SVPullToRefresh.framework"
fi
