...
#define DEFAULT_TOP_FADING_HEIGHT_HALF 0
...
@property (nonatomic, strong) RandomImageView *backgroundImageView;
@property (nonatomic, strong) RandomImageView *blurredBackgroundImageView;
@property(nonatomic, assign)BOOL needsBlur;
@property(nonatomic, assign)BOOL removeRandomImages;
